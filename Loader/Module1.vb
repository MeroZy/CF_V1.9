...
#Region " Dark Colors"
    ...
    Private _BorderColor As Color = Color.FromArgb(255, 165, 0)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            .FillRectangle(New SolidBrush(Color.FromArgb(255, 165, 0)), 16, 16, 4, 18)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- if ShowText
            If ShowText Then
                .DrawString(Text, Font, New SolidBrush(Color.FromArgb(255, 165, 0)), New Rectangle(16, 16, W, H), NearSF)
            End If
        End With
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(255, 165, 0)
    Private _TextColor As Color = Color.FromArgb(243, 243, 243)
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(255, 165, 0)
    Private BaseColorRed As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
    ...
    Private _ActiveColor As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _ProgressColor As Color = Color.FromArgb(255, 165, 0)
    Private _DarkerProgress As Color = Color.FromArgb(255, 165, 0)
...
#End Region
    ...
    Sub DrawItem_(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DrawItemEventArgs) Handles Me.DrawItem
        ...
        If (e.State And DrawItemState.Selected) = DrawItemState.Selected Then
            '-- Selected item
            e.Graphics.FillRectangle(New SolidBrush(Color.FromArgb(255, 165, 0)), e.Bounds)
        Else
            '-- Not Selected
...
#Region " Colors"
    ...
    Private _HoverColor As Color = Color.FromArgb(255, 165, 0)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        With G
            .Clear(Color.FromArgb(255, 165, 0))
            .SmoothingMode = 2
            .PixelOffsetMode = 2
            .TextRenderingHint = 5
...
#Region " Colors"
    ...
    Private _BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _ButtonColor As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
    ...
    Private _SelectedColor As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
        ...
        Private CheckedColor As Color = Color.FromArgb(255, 165, 0)
        Private BorderColor As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
    ...
    Private BaseColor As Color = Color.FromArgb(60, 60, 60)
    Private _TrackColor As Color = Color.FromArgb(255, 165, 0)
    Private SliderColor As Color = Color.FromArgb(75, 75, 75)
    Private _HatchColor As Color = Color.FromArgb(255, 165, 0)
...
#Region " Colors"
    ...
    Private _RectColor As Color = Color.FromArgb(255, 165, 0)
